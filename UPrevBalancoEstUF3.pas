...
type
  TfPrevBalancoEstUF3 = class(TForm)
    Panel2: TPanel;
    Panel1: TPanel;
    BitBtn6: TBitBtn;
    BitBtn1: TBitBtn;
...
var
  fPrevBalancoEstUF3: TfPrevBalancoEstUF3;
...
procedure TfPrevBalancoEstUF3.Le_mConsulta;
var
  vQtdAux : Real;
  vQtdEstoque : Real;
  vCodCorAux : String;
...
procedure TfPrevBalancoEstUF3.Grava_mConsultaEnt;
var
  vLargAux : String;
  vVlrAux  : Real;
begin
  ...
  if (StrToFloat(FormatFloat('0.00',qMaterialICMS.AsFloat)) = 17) or (StrToFloat(FormatFloat('0.00',qMaterialICMS.AsFloat)) = 0) then
  begin
    ...
    mConsultaAliqIcms.AsFloat := StrToFloat(FormatFloat('0.00',qMaterialICMS.AsFloat));
...
procedure TfPrevBalancoEstUF3.Grava_mConsultaSai(Qtd : Real);
var
  vLargAux : String;
  vVlrAux  : Real;
begin
...
procedure TfPrevBalancoEstUF3.Monta_SQL;
begin
  ...
  qMaterial.SQL.Add('Dbestoquematmov.TipoMov, Dbestoquematmov.ES, Dbestoquematmov.CodCliForn, dbEstoqueMatMov.DtMov ');
  ...
  //qMaterial.SQL.Add('  AND (Dbestoquematmov.CodMaterial = 5600 or Dbestoquematmov.CodMaterial = 145) ');
  ...
  qMaterial.SQL.Add(' Dbestoquematmov.CodCor, Dbestoquematmov.Largura, Dbestoquematmov.PercIcms, Dbestoquematmov.PercIpi, Dbestoquematmov.TipoMov, Dbestoquematmov.ES, Dbestoquematmov.CodCliForn, dbEstoqueMatMov.DtMov');
  qMaterial.SQL.Add('ORDER BY dbEstoqueMatMov.Es, dbEstoqueMatMov.CodMaterial, dbEstoqueMatMov.CodCor, dbEstoqueMatMov.Largura, dbEstoqueMatMov.DtMov ');
  qMaterial.Open;
  ...
  //qSaida.SQL.Add('  AND (Dbestoquematmov.CodMaterial = 5600 or Dbestoquematmov.CodMaterial = 145) ');
  if vMercado <> '' then
    begin
...
procedure TfPrevBalancoEstUF3.Imprime_Cabecalho;
var
  Texto1 : String;
  I : Integer;
begin
...
procedure TfPrevBalancoEstUF3.Imprime_Detalhe;
var
 i: Integer;
...
procedure TfPrevBalancoEstUF3.Imprime_TotalUF;
var
 i: Integer;
 Texto1, Texto2 : string;
begin
...
procedure TfPrevBalancoEstUF3.Imprime_Rodape;
var
 i: Integer;
 Texto1, Texto2 : string;
begin
...
procedure TfPrevBalancoEstUF3.Le_qMaterial;
var
  Texto : String;
  vFlag : Boolean;
begin
...
procedure TfPrevBalancoEstUF3.Le_qSaida;
var
  Texto : String;
begin
  ...
  mConsulta.IndexFieldNames := 'CodMaterial;CodCor;Largura;Item;UF';
  qSaida.First;
...
procedure TfPrevBalancoEstUF3.Imprimir;
var
  Texto : String;
begin
...
procedure TfPrevBalancoEstUF3.BitBtn6Click(Sender: TObject);
begin
  //qMaterial.Open;
...
procedure TfPrevBalancoEstUF3.BitBtn1Click(Sender: TObject);
begin
  Close;
end;

procedure TfPrevBalancoEstUF3.FormClose(Sender: TObject;
...
procedure TfPrevBalancoEstUF3.FormShow(Sender: TObject);
begin
  DM1.tCor.Open;
  DM1.tMaterial.Open;
