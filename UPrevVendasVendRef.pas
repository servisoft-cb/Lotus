...
type
  TfPrevVendasVendRef = class(TForm)
    Panel1: TPanel;
    Panel3: TPanel;
    BitBtn6: TBitBtn;
    BitBtn1: TBitBtn;
...
var
  fPrevVendasVendRef: TfPrevVendasVendRef;
...
procedure TfPrevVendasVendRef.Monta_Tab;
var
 i, vQtdAux : Integer;
begin
  for i := 1 to 12 do
...
procedure TfPrevVendasVendRef.Imprimir;
var
 i,flag : Integer;
  ...
  while not tAuxVendasRef.Eof do
    begin
      ...
      if RadioGroup2.ItemIndex = 0 then
        tAuxVendas.Filter   := 'Codigo = ''' + tAuxVendasRefReferencia.AsString + ''' and DescMaterial = ''' + tAuxVendasRefDescMaterial.AsString + ''''
      else
        tAuxVendas.Filter   := 'Codigo = ''' + tAuxVendasRefReferencia.AsString + ''' and DescMaterial = ''' + tAuxVendasRefDescMaterial.AsString + ''' and CodCor = ''' + tAuxVendasRefCodCor.AsString + '''';
...
procedure TfPrevVendasVendRef.Imprime_Cabecalho;
var
 i : Integer;
 texto1 : String;
begin
  ...
  For i := 1 to 53 - Length(Texto1) do
    Texto1 := Texto1 + ' ';
  Texto1 := Texto1 + 'RELACAO DE VENDAS POR REFERENCIA                            Pagina.: ' + IntToStr(pagina);
  Writeln(F,Texto1);
  ...
  if Pagina < 2 then
    begin
      if RadioGroup2.ItemIndex = 0 then
        Writeln(F,'  Referencia  Material                           Construcao')
      else
        Writeln(F,'  Referencia  Material       Cor                 Construcao');
    end;
...
{  Referencia  Material     Cor
    Jan/2002  Fev/2002  Mar/2002  Abr/2002  Mai/2002  Jun/2002  Jul/2002  Ago/2002  Set/2002  Out/2002  Nov/2002  Dez/2002     Total
------------------------------------------------------------------------------------------------------------------------------------}

end;

procedure TfPrevVendasVendRef.Imprime_Detalhe;
var
 i, i2: Integer;
 Texto1, Texto2 : string;
begin
  TextoQtd := tAuxVendasRefReferencia.AsString;
  for i := 1 to 8 - Length(TextoQtd) do
    TextoQtd := ' ' +  TextoQtd;
  TextoQtd := ' ' + TextoQtd;

  Texto1 := '';
  Texto1 := tAuxVendasRefDescMaterial.AsString;
  ...
  Texto1 := '';
  Texto1 := tAuxVendasRefConstrucao.AsString;
  for i := 1 to 15 - Length(Texto1) do
    Texto1 := Texto1 + '-';
  TextoQtd := TextoQtd + '-----' + Texto1;
...
procedure TfPrevVendasVendRef.FormClose(Sender: TObject;
...
procedure TfPrevVendasVendRef.BitBtn6Click(Sender: TObject);
var
 Ano,Mes,Dia : Word;
 i : Integer;
begin
                ...
                begin
                  ...
                  while not DM1.tPedidoItem.EOF do
                    begin
                      ...
                      tAuxVendasRefReferencia.AsString   := DM1.tPedidoItemlkReferencia.AsString;
                      tAuxVendasRefDescMaterial.AsString := DM1.tPedidoItemlkDescMaterial.AsString;
                      if RadioGroup2.ItemIndex = 0 then
                      ...
                      if tAuxVendasRef.GotoKey then
                        ...
                        begin
                          ...
                          tAuxVendasRefReferencia.AsString   := DM1.tPedidoItemlkReferencia.AsString;
                          tAuxVendasRefDescMaterial.AsString := DM1.tPedidoItemlkDescMaterial.AsString;
                          tAuxVendasRefConstrucao.AsString   := DM1.tPedidoItemlkConstrucao.AsString;
                          if RadioGroup2.ItemIndex = 0 then
                            tAuxVendasRefCodCor.AsInteger     := 0
                          else
                            tAuxVendasRefCodCor.AsInteger     := DM1.tPedidoItemCodCor.AsInteger;
                      ...
                      tAuxVendasCodigo.AsString        := DM1.tPedidoItemlkReferencia.AsString;
                      tAuxVendasDescMaterial.AsString  := DM1.tPedidoItemlkDescMaterial.AsString;
                      if RadioGroup2.ItemIndex = 0 then
              ...
              while not DM1.tNotaFiscal.EOF do
                begin
                  ...
                  while not DM1.tNotaFiscalItens.EOF do
                    begin
                      tAuxVendasRef.SetKey;
                      tAuxVendasRefReferencia.AsString    := DM1.tNotaFiscalItenslkReferencia.AsString;
                      tAuxVendasRefDescMaterial.AsString  := DM1.tNotaFiscalItenslkDescMaterial.AsString;
                      if RadioGroup2.ItemIndex = 0 then
                        tAuxVendasRefCodCor.AsInteger := 0
                      else
                      ...
                      if tAuxVendasRef.GotoKey then
                        ...
                        begin
                          ...
                          tAuxVendasRefReferencia.AsString    := DM1.tNotaFiscalItenslkReferencia.AsString;
                          tAuxVendasRefDescMaterial.AsString  := DM1.tNotaFiscalItenslkDescMaterial.AsString;
                          tAuxVendasRefConstrucao.AsString    := DM1.tNotaFiscalItenslkConstrucao.AsString;
                          if RadioGroup2.ItemIndex = 0 then
                            tAuxVendasRefCodCor.AsInteger := 0
                          else
                            tAuxVendasRefCodCor.AsInteger := DM1.tNotaFiscalItensCodCor.AsInteger;
                      ...
                      tAuxVendasAno.AsInteger          := Ano;
                      tAuxVendasMes.AsInteger          := Mes;
                      tAuxVendasCodigo.AsString        := DM1.tNotaFiscalItenslkReferencia.AsString;
                      tAuxVendasDescMaterial.AsString  := DM1.tNotaFiscalItenslkDescMaterial.AsString;
                      if RadioGroup2.ItemIndex = 0 then
                        tAuxVendasCodCor.AsInteger := 0
                      else
...
procedure TfPrevVendasVendRef.BitBtn1Click(Sender: TObject);
begin
  Close;
end;

procedure TfPrevVendasVendRef.RxDBLookupCombo1DropDown(Sender: TObject);
begin
  DM1.tVendedor.IndexFieldNames := 'Nome';
end;

procedure TfPrevVendasVendRef.RxDBLookupCombo1Exit(Sender: TObject);
begin
  DM1.tVendedor.IndexFieldNames := 'Codigo';
end;

procedure TfPrevVendasVendRef.FormShow(Sender: TObject);
begin
  DM1.tVendedor.Open;
  DM1.tCliente.Open;
  DM1.tProduto.Open;
