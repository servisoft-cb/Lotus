...
uses
  MAPI, SysUtils, Forms, uUtil, DmdDatabase, uNFeComandos, StrUtils;
...
begin
  ...
  try
    ...
    sds_Param.CommandText   := 'SELECT LOCALSERVIDORNFE FROM PARAMETROS ';
    sds_Param.Open;
    ...
    EnviarEmail2(sds_Param.FieldByName('LOCALSERVIDORNFE').AsString,
                 vCNPJ_Filial,
